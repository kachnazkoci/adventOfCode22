...
The list is circular, so moving a number off one end of the list wraps back around to the other end
...
wrapping around the list as necessary. In the above example, the 1000th number after 0 is 4,
the 2000th is -3, and the 3000th is 2; adding these together produces 3.

Mix your encrypted file exactly once. What is the sum of the three numbers that form the grove coordinates?

Your puzzle answer was 7713.
...
Your puzzle answer was 1664569352803.
